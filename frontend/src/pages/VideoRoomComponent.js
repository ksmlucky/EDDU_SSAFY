...
import "../css/VideoRoomComponent.css";
...
class VideoRoomComponent extends Component {
  constructor(props) {
    ...
    let sessionName = this.props.sessionName
      ...
      : String(roomId);
    let userName = this.props.user ? this.props.user : nickName;
    this.remotes = [];
  ...
  render() {
    ...
    return (
      <div className="container" id="container">
        ...
        <ToolbarComponent
          sessionId={this.state.roomTitle}
          user={localUser}
        ...
        <div className="bounds">
          <div className="streamingContainer">
            ...
            <div
              className="subscribersContainer"
              style={
                this.state.chatDisplay === "none"
                  ? {
                      maxWidth: "70vw",
          ...
          {localUser !== undefined &&
            localUser.getStreamManager() !== undefined && (
              <div className="" style={quizDisplay}>
                <QuizComponent
                  user={localUser}
